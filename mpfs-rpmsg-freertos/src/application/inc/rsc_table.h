...
/* This file populates resource table for FreeRTOS remote
...
struct remote_resource_table
{
    ...
    /* vdev entry for rpmsg communication */
...
/*
 * Copy resource table to shared memory base for early boot case
 * In early boot case, Linux kernel need to get resource table before file system gets loaded.
 */
